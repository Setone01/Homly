      ...
      <div className="">
        <div className=" flex justify-center flex-col">
          ...
          <div className=" text-white">
            <div className=" mb-4">
              <h5 className="font-semibold text-[20px] mb-2">Estate/Home Management</h5>
            ...
            <div className="outline-0">
              <button className="text-white text-[12px] hover:bg-secondary font-light border border-white px-9 py-2 rounded-3xl outline-0">
                Learn more
              </button>
            </div>
          </div>
