  ...
  return (
    <div className="w-screen vs:pt-32 md:pt-28 pb-10 overflow-hidden z-20">
      <div className="w-[90%] mx-auto grid vs:grid-cols-1 md:grid-cols-2 items-center vs:gap-12 md:gap-0">
        <div className=" w-full flex justify-center items-start flex-col  flex-1">
          ...
          <div className="flex md:justify-start vs:justify-center item-center gap-12">
            <button className="bg-primary text-white text-[12px] hover:bg-secondary font-light px-6 py-2 rounded-3xl outline-0">
              e-portal login
            </button>
        ...
        <div className=" flex justify-center items-center border-black">
          <img className="vs:w-[75%] md:w-[75%] object-cover" src={HeroImg} alt="" />
        </div>
      </div>
    </div>
  );
