...
const TeamUI = () => {
  return (
    <div className="vs:w-full sm:w-[80%] lg:w-[70%] mx-auto grid ss:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 justify-center gap-6">
      {teams.map((data) => (
        <div key={data.id} className="max-w-md max-h-max flex justify-center flex-col bg-white rounded-md shadow overflow-hidden">
          ...
          <div className="flex justify-center flex-col px-2 py-2">
            ...
            <Link className="text-[9px] text-textGrey capitalize">
              {data.linkedin.title}
            </Link>
          </div>
        </div>
